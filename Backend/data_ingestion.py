...
# # Import modules
# from data_cleaner import DataCleaner, CleaningOptions, get_default_cleaning_options
...
# REGISTRATION_OTP_EXPIRY_SECONDS = int(os.getenv("REGISTRATION_OTP_EXPIRY_SECONDS", 120))
...
# app = FastAPI(
#     title="Data Ingestion & AI Summarization API",
#     description="Upload CSV/Excel files with automatic AI-powered summarization",
#     version="4.0.0"
# )
...
# @app.post("/upload-file", response_model=FileUploadResponse, status_code=status.HTTP_201_CREATED)
# async def upload_file(
#     background_tasks: BackgroundTasks,
#     user_id: str = Form(...),
#     file: UploadFile = File(...),
#     apply_cleaning: bool = Form(False),
#     remove_duplicates: bool = Form(True),
#     fill_missing_values: bool = Form(True),
#     remove_empty_rows: bool = Form(True),
#     remove_empty_columns: bool = Form(True),
#     clean_text: bool = Form(True),
#     standardize_column_names: bool = Form(True),
#     optimize_data_types: bool = Form(True),
#     remove_outliers: bool = Form(False),
#     iqr_multiplier: float = Form(1.5),
#     normalize_numeric: bool = Form(False)
# ):
#     """
#     Upload CSV/Excel file with automatic AI summarization
#     Summary generation runs in background after upload completes
#     """
...
# @app.get("/summarize/{user_id}", response_model=SummaryResponse)
# async def get_summary(user_id: str):
#     """Manually generate AI summary for user's table"""
#     try:
#         uuid.UUID(user_id)
#         table_name = sanitize_table_name(user_id)
...
# @app.get("/table-data/{user_id}", response_model=TableInfoResponse)
...
#                 raise HTTPException(
#                     status_code=404,
#                     detail=f"No data found for user_id: {user_id}"
#                 )
...
# print("\n" + "="*70)
# print("🚀 Data Ingestion & AI Summarization API")
# print("="*70)
...
# print("  🧹 Customizable data cleaning")
# print("  🤖 Automatic AI summarization with LM Studio")
# print("  🔄 Background task processing")
# print("\nEndpoints:")
# print("  POST   /upload-file            - Upload file + auto-summarize")
# print("  GET    /summarize/{user_id}    - Get AI summary")
# print("  GET    /table-data/{user_id}   - Get table data")
# print("  DELETE /table-data/{user_id}   - Delete table")
# print("  GET    /list-user-tables       - List all tables")
# print("\n⚠️  Make sure LM Studio is running on http://127.0.0.1:1234")
# print("="*70 + "\n")
